...
import { FileText, Eye, MessageSquare, Share2, Ban, Trash, ArrowUpRight, ArrowDownRight } from 'lucide-react'
...
export default function ContentPage() {
  ...
  const renderComparison = () => {
    ...
    const previousData = timeFrame === 'daily' ? contentData.daily : timeFrame === 'monthly' ? contentData.monthly : contentData.allTime
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="details">
          <h2 className="text-2xl font-semibold mb-4">Detailed Content Statistics</h2>
          {renderComparison()}
        </TabsContent>
      </Tabs>
    </div>
